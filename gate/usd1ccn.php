...
$sk = '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';
...
curl_setopt($ch, CURLOPT_POSTFIELDS, 'amount='.$chr.'&currency=usd&payment_method_types[]=card&description=Checked by Night Checker&payment_method='.$tok1.'&confirm=true&off_session=true');  
...
if(strpos($result2, '"seller_message": "Payment complete."' )) {
    echo 'CHARGED</span>  </span>CC:  '.$lista.'</span>  <br>➤ Response: $'.$amt.' CCN Charged ✅ Checked by @Deluxe <br> ➤ Receipt : <a href='.$receipturl.'>Here</a><br>';
}
